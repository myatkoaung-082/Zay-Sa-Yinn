        ...
        <div class="iq-sidebar  sidebar-default ">
            ...
            <div class="sidebar-caption dropdown">
                <a href="#" class="iq-user-toggle d-flex align-items-center justify-content-between"
                    ...
                    <i class="ri-arrow-down-s-line font-size-20 mr-1"></i>
                </a>
                <div class="dropdown-menu w-100 border-0 my-2" aria-labelledby="dropdownMenuButton">
                    ...
                    <hr class="my-2">
                    <a class="dropdown-item" href="{{route('logout')}}">
                        <i class="ri-logout-circle-r-line font-size-20 mr-1"></i>
                        ...
                        <div class="card-body write-card">
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                ...
                                <div class="media flex-wrap align-items-center">
                                    ...
                                    <a href="#" class="btn btn-primary add-btn" data-toggle="modal" data-target="#new-item"><i class="ri-add-line mr-3"></i>Add Item</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="popup text-left">
                                        <h4 class="mb-4 text-center">Add New Item</h4>
                                        <div class="content add-itemform">
                                        <form method="post" id="add-itemform" enctype="multipart/form-data">
                                            @csrf
                                            <div class="content-box mb-2">
                                                <h5 class="mb-2">Buyed Date</h5>
                                                <input type="date" class="form-control" name="itemBuyedDate" data-change="input"
                                                    data-custom-target="#note-reminder-date">
                                            </div>
                                            <div class="content-box mb-2">
                                                <h5 class="mb-2">Item Name</h5>
                                                <textarea type="text" class="form-control" name="itemName" placeholder="Enter Item Name"></textarea>
                                            </textarea>
                                            </div>
                                            <div class="content-box mb-2">
                                            ...
                                            <div class="mb-2">
                                                <h5 class="mb-2">Item Images (Multiple)</h5>
                                                <div class="image-upload-wrapper">
                                                    <!-- ပုံမရွေးရသေးရင် မပြချင်လို့ `d-none` ထည့်ထားပါမယ် -->
                                                    <div class="image-preview-container row mb-3 d-none" id="imagePreviews"></div>
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="itemImages"
                                                            name="itemImages[]" multiple accept="image/*">
                                                        <label class="custom-file-label" for="itemImages">Choose images (Max 5)</label>
                                                    </div>
                                            ...
                                            <div class="col-lg-12 mt-4">
                                                <div class="d-flex flex-wrap align-items-ceter justify-content-center">
                                                    <button type="button" class="btn btn-primary mr-4" data-dismiss="modal">Cancel</button>
                            ...
                            <ul class="list-inline m-0 p-0 d-flex align-items-center justify-content-around">
                                <li class="nav-item nav-icon dropdown">
                                    <a href="#" class="search-toggle dropdown-toggle nav-icon-1" id="dropdownMenuButton2"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="">
                                            <svg width="20" class="svg-icon" id="main-n-01" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
                                                    style="stroke-dasharray: 82, 102; stroke-dashoffset: 0;"></path>
                                            </svg>
                                        </i>
                                        <span class="badge badge-primary count-mail mail rounded-circle">2</span>
                                        <span class="bg-primary"></span>
                                ...
                                <li class="nav-item nav-icon dropdown pl-3">
                                    <a href="#" class="search-toggle dropdown-toggle nav-icon-1" id="dropdownMenuButton002"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="">
                                            <svg width="20" class="svg-icon" id="main-n-02" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"
