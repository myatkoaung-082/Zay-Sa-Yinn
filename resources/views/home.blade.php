                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                          ...
                                          <div class="px-3 pt-0 pb-0">
                                              <a href="#" class="iq-sub-card">
                                                  <div class="media align-items-center cust-card py-3 border-bottom">
                                                      <div class="">
                                                          <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/01.jpg')}}" alt="01">
                                                      </div>
                                              ...
                                              <a href="#" class="iq-sub-card">
                                                  <div class="media align-items-center cust-card py-3 border-bottom">
                                                      <div class="">
                                                          <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/02.jpg')}}" alt="02">
                                                      </div>
                                                      <div class="media-body ml-3">
                                                          <div class="d-flex align-items-center justify-content-between">
                                              ...
                                              <a href="#" class="iq-sub-card">
                                                  <div class="media align-items-center cust-card py-3">
                                                      <div class="">
                                                          <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/03.jpg')}}" alt="03">
                                                      </div>
                                                      <div class="media-body ml-3">
                                                          <div class="d-flex align-items-center justify-content-between">
                          ...
                          <li class="caption-content">
                             <a href="#" class="iq-user-toggle d-flex align-items-center justify-content-between" id="h-dropdownMenuButton001" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <img src="{{asset('assets/images/user/1.jpg')}}" class="img-fluid rounded avatar-50" alt="user">
                              </a>
                              <div class="dropdown-menu dropdown-menu-right w-100 border-0 py-2" aria-labelledby="h-dropdownMenuButton001">
                                  <a class="dropdown-item mb-2" href="https://cors-anywhere.herokuapp.com/https://templates.iqonic.design/note-plus/html/assets/vendor/line-awesome/dist/line-awesome/fonts/la-solid-900.woff2
">
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="index.html" class="header-logo">
                  <img src="{{asset('assets/images/Shopping_Logos/shopping_logo.avif')}}" class="img-fluid rounded-normal light-logo" alt="logo"> <h4 class="logo-title ml-3">Zay Sa Yinn</h4>
              </a>
                                        ...
                                        <div class="card card-transparent card-block card-stretch event-note">
                                            <div class="card-body px-0 bukmark">
                                                ...
                                                <div id="quill-toolbar">
                                                    ...
                                                    <img src="{{asset('assets/images/event-note/01.png')}}" class="img-fluid image-1" alt="image">                                                    
                                                    <img src="{{asset('assets/images/event-note/02.png')}}" class="img-fluid image-2" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                    
                                                ...
                                                <div class="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                                                    ...
                                                    <div class="card-body rounded">
                                                        ...
                                                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/08.jpg')}}" class="img-fluid note-image rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/05.jpg')}}" class="img-fluid note-image rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/03.jpg')}}" class="img-fluid note-image rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                                                    ...
                                                    <div class="card-body rounded">
                                                        ...
                                                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/01.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/02.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                            <li class="col-4">
                                                                <a href="#">
                                                                    <img src="{{asset('assets/images/gallery/grid/03.jpg')}}" class="img-fluid rounded" alt="" />  
                                                                </a> 
                                                            </li>
                                                        </ul>
                                                    </div>
                            ...
                            <div class="content create-workform">
                                ...
                                <ul class="list-inline p-0 m-0">
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/02.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/03.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="popup text-left">
                            ...
                            <div class="content create-workform mb-4">
                                <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/01.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/02.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                    <li class="col-md-4 mb-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/03.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/04.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/05.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                    <li class="col-md-4">
                                        <a href="#">
                                            <img src="{{asset('assets/images/gallery/grid/06.jpg')}}" class="img-fluid rounded avatar-150" alt="">  
                                        </a> 
                                    </li>
                                </ul>
                            </div>
                            ...
                            <ul class="list-inline p-0 m-0">
                                <li>
                                    <div class="media align-items-center cust-card mb-3">
                                        <div class="">
                                            <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/04.jpg')}}" alt="01">
                                        </div>
                                        <div class="media-body ml-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <h5 class="mb-0">Anne Effit</h5>
                            ...
                            <div class="content create-workform">
                                ...
                                <ul class="list-inline p-0 m-0">
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/05.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h5 class="mb-0">Poall Molve</h5>
                            ...
                            <div class="content create-workform">
                                ...
                                <ul class="list-inline p-0 m-0">
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/06.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h5 class="mb-0">Anne Effit</h5>
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/07.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h5 class="mb-0">Poall Molve</h5>
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/08.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <li>
                                        <div class="media align-items-center cust-card mb-3">
                                            <div class="">
                                                <img class="avatar-50 rounded-small" src="{{asset('assets/images/user/09.jpg')}}" alt="01">
                                            </div>
                                            <div class="media-body ml-3">
                                                <div class="d-flex align-items-center justify-content-between">
